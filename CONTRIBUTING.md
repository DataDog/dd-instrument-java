...
Have you fixed a bug and want to share it? Many thanks!
...
Avoid changing too many things at once. For instance if you're fixing a bug and at the same time reformatting some code, it makes reviewing harder and the _time-to-release_ longer.
